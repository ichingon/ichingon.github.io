...
This site is built with [Hugo](https://gohugo.io/), an open-source static site generator under the [Apache 2.0](https://www.apache.org/licenses/LICENSE-2.0) license.

The visual theme used is [Blowfish](https://github.com/nunocorvalho/blowfish), developed by [Nuno Corvalho](https://github.com/nunocorvalho), distributed under the [MIT](https://opensource.org/licenses/MIT) license.
...
All content published under Layer 2 (translations and original articles by Dailingna Romero) is accompanied by a **cryptographic signature** published on the [Nostr](https://nostr.com) decentralized network.

This signature serves three functions:

1. **Proof of authorship**: Mathematically demonstrates that the content was created by the digital identity `dailingna@elichingon.com`.
2. **Immutable timestamp**: Records the exact date and time of original publication, establishing temporal priority in cases of plagiarism or dispute.
3. **Independent verification**: Anyone can verify the authenticity of the content without relying on centralized platforms, lawyers, or courts.
...
Each signed article includes a verification block at the end of the content with a link to the corresponding Nostr note. For more details on the technical verification process, see the [authenticity verification](https://elichingon.com/verify/) page.

**Verified identity**: `dailingna@elichingon.com`  
**Protocol**: [Nostr](https://nostr.com) / [NIP-05](https://github.com/nostr-protocol/nips/blob/master/05.md)
...
> "Original text by Richard Wilhelm (public domain). Spanish translation and articles by Dailingna Romero / [elichingon.com](https://elichingon.com), used under [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/) license."
