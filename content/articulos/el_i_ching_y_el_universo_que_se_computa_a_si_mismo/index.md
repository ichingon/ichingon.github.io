---
title: "El I Ching y el universo que se computa a sí mismo"
date: 2026-06-28
...
description: "¿Es nuestra realidad un software? Descubre cómo el I Ching y su código binario anticiparon la física cuántica y la era digital."
summary: 'Desde la antigüedad hasta los colisionadores de partículas y la inteligencia artificial, la pregunta más fundamental persiste: ¿Qué es el universo? En este artículo, proponemos una síntesis audaz: el universo no está hecho de materia sólida, sino de información. El I Ching, con su sistema binario de Yin y Yang, se anticipó a esta idea hace. Hoy, la física cuántica nos muestra que la realidad, a su nivel más fundamental, se comporta como un "software en ejecución". Pero si el universo es código, ¿dónde encaja la conciencia? ¿Somos meros espectadores o somos el universo procesándose a sí mismo? Exploramos esta paradoja a través de la lente de la filosofía oriental (Tao Te Ching, Budismo) y los desafíos planteados por la ciencia moderna, como el "Problema Difícil de la Conciencia" de David Chalmers.'
draft: false
---
...
Si las líneas individuales yin o yang son bits, o digitos binarios, vamos ahora a esbozar una arquitectura de datos semántica de las distintas secuencias de n bits. Básicamente, pretendemos hacer ingeniería inversa para extraer el [código fuente o el "sistema algebraico" del I Ching]({{< relref "articulos/el-abc-del-i-ching#libro-sin-palabras" >}}), asignándole a cada bit la función exacta que cumple dentro del algoritmo de la realidad.
...
Estas cuatro imágenes o bigramas son el [componente básico del I Ching en su aplicación oracular]({{< relref "articulos/como-consultar-el-iching-con-las-monedas#cuatro-imagenes" >}}). Las cuatro imagenes nos dan entonces el algoritmo básico del cambio. Introducen el componente temporal en nuestro sistema de representación y codifican el principio fundamental del I Ching referente a los "extremos que conducen a la reversión"- Wù jí bì fǎn (物极必反).
...
![Un modelo funcional de una máquina de Turing](turing-machine.webp "Un modelo funcional de una máquina de Turing")
