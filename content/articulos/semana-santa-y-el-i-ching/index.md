...
description: "El simbolismo de la Semana Santa desde la óptica del I Ching: una lectura estructural del Triduo Pascual a través de los hexagramas 23, 2 y 24."
summary: "Exploramos cómo el I Ching codifica el misterio de la muerte y resurrección de Cristo en los hexagramas 23 (Desintegración), 2 (La Tierra) y 24 (El Retorno), revelando el Sábado Santo como un estado atemporal y corazón de ambos procesos."
math: false
draft: false
---
...
Cada año, millones de cristianos en todo el mundo celebran el Triduo Pascual: tres días que conmemoran la pasión, muerte y resurrección de Jesucristo. Pero más allá de su significado religioso, estos tres días encierran un arquetipo universal: el ciclo de muerte y renacimiento que subyace a toda transformación profunda.

Desde la óptica del I Ching - el antiguo Libro de las Mutaciones chino - este ciclo encuentra un paralelismo sorprendente en tres hexagramas concretos: el **[23 (Bō, la Desintegración)]({{% relref "/hexagramas/hex23" %}})** , el **[2 (Kūn, la Tierra)]({{% relref "/hexagramas/hex02" %}})** y el **[24 (Fù, el Retorno)]({{% relref "/hexagramas/hex24" %}})** . La estructura de estos hexagramas, su disposición en la secuencia del Rey Wen y sus relaciones internas revelan una codificación casi matemática del misterio pascual.
...
> *Arriba:* ☶ Gèn, la Montaña  
> *Abajo:* ☷ Kūn, la Tierra

El [hexagrama 23]({{% relref "/hexagramas/hex23" %}}), conocido como *Bō* (que significa "desgastar", "despojar" o "desintegrar"), describe el proceso en el que las estructuras se quiebran desde su base. Es un tiempo en que lo que antes era sólido se desmorona, y lo bajo avanza para derribar lo que está arriba[^1].
...
{{< video src="cristo_crucificado.webm" >}}
...
> *Arriba:* ☷ Kūn, la Tierra  
> *Abajo:* ☷ Kūn, la Tierra

El Sábado Santo es el día del sepulcro. No hay movimiento. No hay acción. Es un día de pura quietud, de silencio, de espera.

En el I Ching, esa quietud total corresponde al **[hexagrama 2, Kūn (坤), la Tierra]({{% relref "/hexagramas/hex02" %}})** . Está constituido exclusivamente por seis líneas yin (quebradas), sin una sola línea de energía yang. Es la receptividad absoluta, el vacío fértil, la matriz de toda posibilidad.

Kūn es el complemento perfecto del [hexagrama 1 (Qián, lo Creativo)]({{% relref "/hexagramas/hex01" %}}). No son opuestos que combaten, sino complementos que se necesitan. Si el Cielo (Qián) es la fuerza que engendra, la Tierra (Kūn) es la que nutre y sostiene. Es la energía femenina del universo: abierta, fértil, dispuesta a recibir.
...
El Domingo de Pascua es la resurrección. En el I Ching, esto es el **[hexagrama 24, Fù (復), el Retorno]({{% relref "/hexagramas/hex24" %}})** .
...
El ideograma *fù* se traduce como "regresar, volver, retornar". Pero no es un simple retorno al punto de partida: es un **retorno transformado**, una vuelta que trae consigo la experiencia de la muerte y la promesa de la vida nueva.
...
Hasta aquí, la correspondencia es clara:

- **Viernes Santo → [Hexagrama 23]({{% relref "/hexagramas/hex23" %}}) (Desintegración)**
- **Sábado Santo → [Hexagrama 2]({{% relref "/hexagramas/hex02" %}}) (La Tierra)**
- **Domingo de Pascua → [Hexagrama 24]({{% relref "/hexagramas/hex24" %}}) (El Retorno)**
...
Pero hay un detalle aún más profundo, que refuerza esta lectura de manera casi sobrecogedora.
...
En el video que inspiró este artículo, mencionaba que "el I Ching se revela como una herramienta notacional, un lenguaje matemático, para pensar sobre estos misterios".
...
El Triduo Pascual y los hexagramas 23, 2 y 24 del I Ching nos ofrecen una misma verdad desde dos lenguajes diferentes:
...
{{< youtube-short "_7Z2761ro_4" "El simbolismo de Semana Santa desde la óptica del I Ching | Hexagramas 23, 2 y 24" >}}

[^1]: Sobre el hexagrama 23 hablo en este video:
    {{< youtube-short "qqd-ZRyxvBI" "Hexagrama 23 - El Colapso" >}}