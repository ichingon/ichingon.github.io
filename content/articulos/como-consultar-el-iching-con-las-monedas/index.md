...
En lo que sigue, haremos un simulacro de consulta como ejemplo.
...
De esta forma, vamos lanzando las tres monedas sucesivamente para obtener la línea 3 ...
... la línea cuatro ...
En la línea cinco, tenemos un valor de ocho, que es Yin ...
Y finalmente, para la línea seis, tenemos dos sellos y una cara, para un valor total de siete, que es Yang.
...
Lo primero que tenemos que hacer es sacar el hexagrama resultante. 
---

El hexagrama resultante describe la situación manifiesta que se presenta ante nosotros en referencia a la pregunta que hicimos.

Para obtener el hexagrama resultante a partir de los valores numéricos de las seis líneas, debemos considerar una línea como Yang si su valor resultante es impar: siete o nueve. Una línea será Yin si su valor resultante respectivo es par: seis u ocho. Para nuestro ejemplo, obtenemos un hexagrama resultante como el que vemos:  

Buscando el hexagrama cuyo trigrama inferior es 乾 y superior 離 en la tabla de nuestro ejemplar del I Ching, encontramos que el hexagrama resultante es el 14.
