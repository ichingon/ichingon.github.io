---
title: "Hexagramm 1 dieses Projekts – Warum wurde El I Chingón geboren? (Über @ElIChingon)"
date: 2026-09-04
...
{{< audio src="/audio/Chypho-Boreal-III.mp3" title="Hintergrundmusik: Chypho - Boreal III" >}}
...
{{< image-left-text image="computer-intro-cover.webp" alt="Das Hexagramm 48 – Der Brunnen" text="‚Computer Intro‘ war kein weiteres Videospiel – es war eine grundlegende Einführung in die Programmierung, aber, stellt euch das vor, in Assemblersprache. Es kam mit einem 144-seitigen Tutorial-Heft und von der Einführung an war ich für immer gefesselt. Die Einführung gab einen kurzen historischen Abriss der ersten Computer: von den Fingern, dem chinesischen Abakus, Charles Babbages analytischer Maschine..." >}}

![Die Seiten 2 und 3 des Tutorial-Textes, der mit der Computer Intro-Kassette geliefert wurde](in-the-beginning.webp "Die Seiten 2 und 3 des Tutorial-Textes, der mit der Computer Intro-Kassette geliefert wurde")
...
![Mein erster Computer – ein TRS‑80 Color Computer mit 16K Arbeitsspeicher](dailingna-coco1-1983.webp "Ich mit 11 Jahren, wie ich meinen ersten Computer präsentiere – ein TRS‑80 Color Computer mit 16K Arbeitsspeicher")
...
![Ich zeige meiner Mutter meine Version des ELIZA-Programms. 1986](dailingna_and_mother_1986.webp "Ich zeige meiner Mutter meine Version des ELIZA-Programms. 1986")
...
![Statue des Konfuzius in Uruguay. Foto: Azsur auf Wikimedia Commons.](confucio.webp "Statue des Konfuzius in Uruguay. Foto: Azsur auf Wikimedia Commons.")
...
Was ist, wenn Yin und Yang des I Ging die Grundlage einer universellen Sprache sind, mit der sich das [Universum selbst berechnet?]({{< relref "articulos/el_i_ching_y_el_universo_que_se_computa_a_si_mismo" >}}) Warum hat jedes Hexagramm oder jede binäre Sequenz von 6 Bits (Yin/Yang) ihre eigene besondere Bedeutung? Wie konnten die alten Chinesen die Bedeutung jeder sich wandelnden Linie eines Hexagramms ableiten und diese Bedeutung als Ratschlag für den Ratsuchenden im Text festhalten?
