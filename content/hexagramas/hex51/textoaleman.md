---
title: "Hexagramm 51 震 - DSCHEN / DAS ERREGENDE"
draft: false
description: "Richard Wilhelms vollständige Untersuchung und Analyse von Hexagramm 51 (DSCHEN) des I Ging mit Unicode-Zeichen und Pinyin."
keywords: ["I Ching", "I Ging", "Hexagramm 51", "DSCHEN", "Das Erregende", "Richard Wilhelm", "震"]
showDate: false
...
Furcht und Zittern der Erschütterung kommt zuerst an einen, so daß man den andern gegenüber sich in Nachtail gestellt sieht. Aber das ist nur vorläufig. Wenn man durch das Gericht hindurch ist, so kommt die Erleichterung. Und so bringt gerade der Schrecken, in den man zunächst hinein muß, im ganzen betrachtet, Heil.
