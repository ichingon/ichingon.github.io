...
> Escudriña el oráculo una vez más,
> para ver si tienes elevación, duración y perseverancia;
> entonces no habrá tacha.
> Los inseguros se acercan paulatinamente.
> Quien llega demasiado tarde, tiene desventura.
...
> Así los reyes de los tiempos antiguos otorgaron los distintos estados como feudos y mantuvieron un trato amistoso con los príncipes feudales.
...
> Mantén la fidelidad y la verdad hacia él: esto no es una tacha.
> Veracidad como un tazón de arcilla lleno:
> Así llega finalmente la ventura desde el exterior.

Cuando se trata de entablar relaciones, la plena veracidad es la única base correcta. Esta disposición, que se representa bajo la imagen de un tazón de barro lleno, en el cual todo es contenido y nada es forma vacía, no se expresa con palabras astutas, sino a través de la fuerza del interior, y esta fuerza es tan grande que atrae hacia sí la ventura desde el exterior con poder.
...
> También exteriormente mantén la unión con él.
> La perseverancia trae ventura.

Las relaciones con un hombre que es el centro de la solidaridad están aquí ya firmemente reguladas. Allí uno puede y debe mostrar su adhesión también abiertamente. Uno solo debe permanecer firme y no dejarse confundir por nada.
...
Se muestra aquí a un soberano o a un hombre influyente al cual los hombres acuden. A quien viene a él, lo recibe; a quien no viene, lo deja correr. No ruega a nadie, no lisonjea a nadie: todos vienen por sí mismos. De este modo se forma una libre dependencia en aquellos que se mantienen unidos a él. La gente no necesita obligarse violentamente, sino que puede mostrar sus disposiciones con naturalidad. No se requiere de medidas policiales. Están afectos a su señor por sí mismos. También para la vida en general vale esta libertad. No se debe cortejar el favor de los hombres. Si uno desarrolla en sí la pureza y la fuerza necesarias para un centro de congregación, los hombres que le están destinados vendrán por sí mismos.

### Seis arriba significa:

> Él no encuentra una cabeza para la solidaridad. Desventura.

La cabeza es el comienzo. Sin un comienzo correcto no hay un final correcto. Si uno ha dejado pasar la oportunidad de unirse y ahora titubea continuamente, recelando de una entrega plena y verdadera, habrá de arrepentirse demasiado tarde de su error.
...
### Enlaces de Consulta
* [El texto original en Alemán](./hex8.de.md)
