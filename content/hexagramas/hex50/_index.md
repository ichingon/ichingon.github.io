---
title: "Hexagrama 50 鼎 - Ding / El Caldero"
draft: false
description: "Traducción crítica y análisis del Hexagrama 50 (Ding) del I Ching basado en la versión de Richard Wilhelm, adaptada para una lectura fluida en castellano."
keywords: ["I Ching", "Hexagrama 50", "Ding", "El Caldero", "Richard Wilhelm", "鼎"]
showDate: false
...
> Sobre la madera está el fuego: la imagen del Caldero.  
> Así el noble consolida su destino  
> colocándose en la posición correcta.
...
> Un caldero con las patas invertidas.  
> Propicio para eliminar lo que está estancado.  
> Se toma una concubina por el bien de su hijo.  
> Sin tacha.
...
> Las asas del caldero se han alterado.  
> Uno se encuentra impedido en su marcha.  
> La grasa del faisán no se consume.  
> Cuando por fin cae la lluvia, el arrepentimiento se agota.  
...
> El caldero se quiebra las patas.  
> El banquete del príncipe se derrama  
> y su apariencia queda deshonrada.  
> ¡Desdicha!
...
> El caldero tiene asas amarillas y anillos de transporte de oro.  
