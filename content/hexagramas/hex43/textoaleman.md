...
keywords: ["I Ching", "I Ging", "Hexagramm 43", "GUAI", "Der Durchbruch", "Richard Wilhelm", "夬"]
showDate: false
...
> Mächtig in den Backenknochen zu sein bringt Unheil. Der Edle ist fest entschlossen. Er wandelt einsam und kommt in den Regen. Er wird bespritzt, und man murrt wider ihn. Kein Makel.
...
> An den Oberschenkeln ist keine Haut, und das Gehen fällt schwer. Ließe man sich führen wie ein Schaf, so würde die Reue schwinden. Wenn man aber diese Worte hört, so wird man sie nicht glauben.

Man leidet an innerer Unruhe, so daß man nicht auf seinem Platz beharren kann. Man möchte unter allen Umständen voran und findet dabei unübersteigliche Hindernisse. So ist man mit seiner Lage in innerem Konflikt. Das kommt von dem Eigensinn, mit dem man seinen Willen durchsetzen möchte. Würde man von dieses Eigensinn lassen, so ginge alles gut. Aber dieser Rat wird wie so viele gute Ratschläge überhört werden. Denn der Eigensinn macht, daß man zwar Ohren hat, aber nicht hört.

### Neun auf fünftem Platz bedeutet:
> Dem Unkraut gegenüber braucht es feste Entschlossenheit. In der Mitte wandeln bleibt frei von Makel.

Unkraut wächst immer wieder nach und läßt sich schwer ausrotten. So bedarf der Kampf gegen einen hochstehenden Gemeinen feste Entschlossenheit. Man steht mit ihm in Beziehung, und es ist infolge davon zu fürchten, da man den Kampf als Hoffnungslos aufgibt. aber das darf nicht sein. Man muß entschlossen weitermachen und darf sich nicht vom Weg abbringen lassen. Nur so bleibt man frei von Makel.
